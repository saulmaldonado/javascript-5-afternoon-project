...
this.addSavedPost = User.prototype.addSavedPost = function(id, title, number){
  this.savedPosts.push({id: id, title: title, number: number})
}
////////// PROBLEM 6 //////////
...
User.prototype.changePostRating = function (id, rating){
  this.savedPosts[this.savedPosts.findIndex(ele => ele.id === id)].rating = rating
}